    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<table><tr><th>VALUE1: </th><th>");
          client.println(val1);
          client.println("A</th></tr></table>");

          //Table Entry2 and Value 2
          client.println("<table><tr><th>VALUE2: </th><th>");
          client.println(val2);
          client.println("A</th></tr></table>");

          //Table Entry3 and Value 3
          client.println("<table><tr><th>VALUE3: </th><th>");
          client.println(val3);
          client.println("A</th></tr></table>");

          //Table Entry4 and Value 4
          client.println("<table><tr><th>VALUE4: </th><th>");
          client.println(val4);
          client.println("A</th></tr></table>");
